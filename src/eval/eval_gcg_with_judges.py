...
MODEL_DICT = {
    ...
    "Qwen2.5-7B-Instruct": "/hub/huggingface/models/Qwen/Qwen2.5-7B-Instruct",
    "Mistral-7B-Instruct" : "/hub/huggingface/models/MistralAI/Mistral-7B-Instruct-v0.3",
...
def init_args():
    ...
    parser.add_argument("--data-dir", type = str, default = "/data/home/Kedong/repos/Dynamic-Target-Prompt-Attacker/data/gcg_results")
    parser.add_argument("--dataset-name", type = str, default = "advbench", choices = ["advbench", "harmBench"])
    ...
    parser.add_argument("--out-dir", type = str, default = "/data/home/Kedong/repos/Dynamic-Target-Prompt-Attacker/data/gcg_results/out_res")
...
def load_target_llm_and_output_path(
    ...
    outFilePath = os.path.join(
        out_dir, f"{dataset_name}_100_{method}_{target_llm}_evaluated_results_{version}.jsonl"
    )
...
def main(args):
    ...
    inFilePath = os.path.join(
        data_dir, target_llm, f"{dst_name}_gcg_100.jsonl"
    )
