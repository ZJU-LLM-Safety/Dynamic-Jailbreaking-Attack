...
# When installed from the repo this resolves to the repo root; when installed
# as a wheel it points inside site-packages (ADV_BENCH_PATH won't be valid,
# but package users supply their own data paths).
...
class DynamicTemperatureAttacker:
    ...
    def optimize_single_prompt_with_suffix_in_double_loop(
        ...
        suffix_init_length: Optional[int] = 5,
        suffix_expand_patience: int = 50,
